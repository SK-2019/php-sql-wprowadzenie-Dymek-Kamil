            ...
            <div id="menubib" class="menubib">Biblioteka</div>
                ...
                <a class="Flexbox" href="../Cwiczenia/index.html">Flexbox</a>
                <div class="menucw">Wieledowielu</div>
                    <div class="menuc">
                <a href="../Wieledowielu/Biblioteka.php">Biblioteka</a>
                <a href="../Wieledowielu/Szkola.php">Szkoła</a> 
                <a href="../Wieledowielu/Przychodnia.php">Przychodnia</a> 
                <a href="../Wieledowielu/Serwis Samochodowy.php">Serwis Samochodowy</a>
                <a href="../Wieledowielu/Sklep.php">Sklep</a> 
                <a href="../Wieledowielu/SPA.php">SPA</a>  
                    </div>  
